package com.example.`in`.api.pt.adapter.`in`

import com.example.core.pt.port.`in`.GeneratePtUseCase
import com.example.`in`.api.pt.adapter.`in`.request.GeneratePtRequest
import com.example.`in`.api.pt.adapter.`in`.response.GeneratePtResponse
import com.example.`in`.api.pt.adapter.`in`.response.HasPtResponse
