package com.example.`in`.api.history.adapter.`in`
...
import com.example.`in`.api.history.adapter.`in`.request.AddDietRequest
import com.example.`in`.api.history.adapter.`in`.request.CompleteTodayExerciseRequest
import com.example.`in`.api.history.adapter.`in`.response.AttendanceResponse
import com.example.`in`.api.history.adapter.`in`.response.ExerciseHistoryResponse
import com.example.`in`.api.history.adapter.`in`.response.HistoryResponse
import com.example.`in`.api.history.adapter.`in`.response.UserHistoryResponse
