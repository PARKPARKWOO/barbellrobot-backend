package com.example.api.rival.adapter.`in`
...
import com.example.api.rival.adapter.`in`.request.UpdateRivalStatusRequest
import com.example.api.rival.adapter.`in`.response.RivalSummaryResponse
