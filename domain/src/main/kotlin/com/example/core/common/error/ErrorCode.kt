...
enum class ErrorCode(
    ...
    MISSING_DETAIL_INFORMATION("detail 정보를 작성하지 않았습니다."),
    ...
    FAILURE_REQUEST_RIVAL("rival 요청에 실패 하였습니다"),
    NOT_FOUND_RIVAL("rival 을 찾을 수 없습니다."),
    DUPLICATED_REQUEST_RIVAL("rival 요청이 이미 있습니다."),
